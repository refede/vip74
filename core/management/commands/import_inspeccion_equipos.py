...
from inspeccion.models import Equipo  # CAMBIA 'tu_app' por el nombre de tu app

# --- DEFINE LA RUTA A TU CSV AQUÍ ---
CSV_PATH = "D:/Users/rflores/Documents/@Refede/Code/db/csv/inspeccion_equipo.csv"
# -----------------------------------------
    ...
    def handle(self, *args, **options):
                ...
                for i, row in enumerate(reader):
                    ...
                    if not nombre:
                        errores_filas.append(
                            f"Línea {line_num}: 'nombre' es obligatorios."
                        )
                        continue
                    ...
                    modelo_instance = Equipo(
                        id          = id,                        
                        nombre      = nombre,
                        marca       = marca,
                        modelo      = modelo,
                        funcion     = funcion,
                        ingreso     = self._cast_to_date(ingreso, "per_fecha_nac", line_num),
        ...
        try:
            with transaction.atomic():
                created_objects = Equipo.objects.bulk_create(
                    elementos_a_crear,
