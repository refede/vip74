...
from inspeccion.models import Propiedad  # CAMBIA 'tu_app' por el nombre de tu app

# --- DEFINE LA RUTA A TU CSV AQUÍ ---
CSV_PATH = "D:/Users/rflores/Documents/@Refede/Code/db/csv/inspeccion_propiedad.csv"
# -----------------------------------------
    ...
    def handle(self, *args, **options):
        ...
        try:
            with transaction.atomic():
                created_objects = Propiedad.objects.bulk_create(
                    elementos_a_crear,
